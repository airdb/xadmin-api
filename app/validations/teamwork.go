...
type TeamworkServiceValidations interface {
	ListLosts(ctx context.Context, request *teamworkv1.ListLostsRequest) error
	GetLost(ctx context.Context, request *teamworkv1.GetLostRequest) error
	CreateLost(ctx context.Context, request *teamworkv1.CreateLostRequest) error
	UpdateLost(ctx context.Context, request *teamworkv1.UpdateLostRequest) error
	DeleteLost(ctx context.Context, request *teamworkv1.DeleteLostRequest) error
}
...
func (w *teamworkServiceValidations) ListLosts(ctx context.Context, request *teamworkv1.ListLostsRequest) error {
...
func (w *teamworkServiceValidations) GetLost(ctx context.Context, request *teamworkv1.GetLostRequest) error {
	return nil
}

func (w *teamworkServiceValidations) CreateLost(ctx context.Context, request *teamworkv1.CreateLostRequest) error {
...
func (w *teamworkServiceValidations) UpdateLost(ctx context.Context, request *teamworkv1.UpdateLostRequest) error {
	user := authkit.FromContextUser(ctx)
	if user == nil || !user.IsAdmin {
		return fmt.Errorf("您无权限执行该操作")
	}
...
func (w *teamworkServiceValidations) DeleteLost(ctx context.Context, request *teamworkv1.DeleteLostRequest) error {
	user := authkit.FromContextUser(ctx)
	if user == nil || !user.IsAdmin {
		return fmt.Errorf("您无权限执行该操作")
	}
